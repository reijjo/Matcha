...
function WhoLikedPreview({ images2, itsMe, userId, username, firstname, lastname, location, age, coordinates, loggedCoords, bio}) {
...
export default WhoLikedPreview;
